...
TRANSLATIONS = {
    "it": {
        ...
        "clock.label": "Orologio",
        "clock.kicker": "Preferenze",
        "clock.settings_title": "Impostazioni orologio",
        "clock.description": "Personalizza formato e fuso orario dell'orologio nella barra superiore.",
        "clock.persistence": "Le impostazioni vengono salvate automaticamente.",
    ...
    "en": {
        ...
        "clock.label": "Clock",
        "clock.label": "Clock",
        "clock.kicker": "Preferences",
        "clock.settings_title": "Clock settings",
        "clock.description": "Customize format and timezone of the top bar clock.",
        "clock.persistence": "Settings are saved automatically.",
