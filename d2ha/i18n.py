...
TRANSLATIONS = {
    "it": {
        ...
        "clock.kicker": "Personalizza",
        "clock.settings_title": "Impostazioni orologio",
        "clock.description": "Gestisci fuso orario, secondi e data direttamente dal browser.",
        "clock.timezone.auto": "Fuso orario automatico",
        "clock.timezone.auto_hint": "Usa automaticamente il fuso orario del dispositivo.",
        "clock.timezone.browser_label": "Fuso orario del browser:",
        "clock.timezone.region": "Regione",
        "clock.timezone.zone": "Città/area",
        "clock.timezone.choose_region": "Scegli una regione",
        "clock.timezone.choose_zone": "Scegli una città/area",
        "clock.seconds.label": "Mostra i secondi",
        "clock.seconds.hint": "Attiva o disattiva la visualizzazione dei secondi nell'orologio.",
        "clock.date.label": "Mostra la data",
        "clock.date.hint": "Mostra la data odierna nel formato gg/mm/aaaa.",
        "clock.persistence": "Le preferenze vengono salvate in questo browser.",
        "clock.saved": "Preferenze salvate.",
        "clock.status.auto": "Utilizzo fuso orario automatico ({tz}).",
        "clock.status.manual": "Utilizzo fuso orario manuale ({tz}).",
    ...
    "en": {
        ...
        "clock.label": "Clock",
        "clock.kicker": "Customize",
        "clock.settings_title": "Clock settings",
        "clock.description": "Control timezone, seconds, and date locally in your browser.",
        "clock.timezone.auto": "Automatic timezone",
        "clock.timezone.auto_hint": "Use the device timezone automatically.",
        "clock.timezone.browser_label": "Browser timezone:",
        "clock.timezone.region": "Region",
        "clock.timezone.zone": "City/area",
        "clock.timezone.choose_region": "Pick a region",
        "clock.timezone.choose_zone": "Pick a city/area",
        "clock.seconds.label": "Show seconds",
        "clock.seconds.hint": "Turn seconds on or off in the clock display.",
        "clock.date.label": "Show date",
        "clock.date.hint": "Show today’s date in dd/mm/yyyy format.",
        "clock.persistence": "Preferences are saved in this browser.",
        "clock.saved": "Preferences saved.",
        "clock.status.auto": "Using automatic timezone ({tz}).",
        "clock.status.manual": "Using manual timezone ({tz}).",
