...
TRANSLATIONS = {
    "it": {
        ...
        "nav.events": "Eventi",
        "nav.home": "Home",
        "networks.title": "Reti Docker",
        "networks.subtitle": "Gestisci e ispeziona le reti Docker e le connessioni dei container.",
        "networks.search_placeholder": "Cerca rete",
        "networks.filter.driver": "Tutte le tipologie",
        "networks.only_custom": "Solo reti utente",
        "networks.create_button": "Crea rete",
        "networks.name": "Nome",
        "networks.driver": "Driver",
        "networks.scope": "Scope",
        "networks.internal": "Interna",
        "networks.attachable": "Attachable",
        "networks.subnet": "Subnet",
        "networks.gateway": "Gateway",
        "networks.containers": "Container",
        "networks.actions": "Azioni",
        "networks.no_data": "Nessuna rete disponibile",
        "networks.create_modal.title": "Crea rete",
        "networks.form.name": "Nome rete",
        "networks.form.name_hint": "Richiesto: un nome univoco per la rete.",
        "networks.form.driver": "Driver",
        "networks.form.internal": "Interna",
        "networks.form.attachable": "Attachable",
        "networks.form.subnet": "Subnet IPv4",
        "networks.form.gateway": "Gateway IPv4",
        "networks.form.labels": "Etichette (facoltative)",
        "networks.form.add_label": "Aggiungi etichetta",
        "networks.form.key": "Chiave",
        "networks.form.value": "Valore",
        "networks.form.cancel": "Annulla",
        "networks.form.create": "Crea",
        "networks.protected_hint": "Rete di sistema protetta",
        "networks.details.attached_containers": "Container collegati",
        "networks.details.no_containers": "Nessun container collegato",
        "networks.details.no_ipam": "Nessuna configurazione IPAM",
        "networks.disconnect": "Scollega",
        "networks.confirm_delete": "Eliminare la rete {name}?",
        "networks.confirm_disconnect": "Scollegare il container dalla rete?",
        ...
        "compact_mode.label": "Modalità compatta",
        "compact_mode.hint": "Riduce spazi e margini per schermi piccoli.",
        ...
        "home.toggle_section": "Mostra o nascondi sezione",
        ...
        "common.mqtt_log": "Log pubblicazioni",
        "updates.title": "Controllo aggiornamenti",
        "updates.summary": "{containers} container analizzati · {images} immagini installate",
        "updates.performance_hint.title": "Modalità prestazioni attiva",
        "updates.performance_hint.body": "Per ridurre il carico, la scansione automatica è disattivata. Avvia manualmente quando serve.",
        "updates.manual_scan": "Scansiona aggiornamenti",
        "updates.table.installed_version": "Vers. installata",
        "updates.table.remote_version": "Vers. remota",
        "updates.table.change_log": "Change log",
        "updates.table.breaking": "Breaking",
        "updates.status.update_available": "Update disponibile",
        "updates.status.up_to_date": "Aggiornato",
        "updates.status.unknown": "Sconosciuto",
        "updates.status.remote_version": "Remota: {version}",
        "updates.status.pending": "In attesa di dati dal registry",
        "updates.changelog.empty": "Nessuna nota",
        "updates.breaking.empty": "Nessuna info",
        "updates.actions.update_image": "Aggiorna immagine",
        "updates.actions.confirm": "Aggiornare l'immagine di {name}?",
        "updates.confirm.title": "Aggiornare l'immagine?",
        "updates.debug.eyebrow": "Debug live",
        "updates.debug.title": "Stream aggiornamento",
        "updates.debug.commands": "Comandi",
        "updates.debug.logs": "Log live",
        "updates.debug.clear": "Pulisci",
        "updates.debug.close": "Chiudi",
        "updates.debug.stream_end": "Stream concluso",
        "updates.debug.stream_error": "Stream interrotto",
        "updates.debug.unavailable": "Debug non disponibile",
        "updates.debug.request": "Richiesta aggiornamento per {name}",
        "updates.debug.state": "Stato: {state}",
        "updates.confirm.prompt": "Vuoi aggiornare l'immagine di \"{name}\"?",
        "updates.confirm.default_name": "questo container",
    },
    "en": {
        ...
        "nav.events": "Events",
        "nav.home": "Home",
        "networks.title": "Docker Networks",
        "networks.subtitle": "View, create and manage Docker networks and attached containers.",
        "networks.search_placeholder": "Search network",
        "networks.filter.driver": "All drivers",
        "networks.only_custom": "User-defined only",
        ...
        "networks.actions": "Actions",
        "networks.no_data": "No networks available",
        "networks.create_modal.title": "Create network",
        "networks.form.name": "Network name",
        "networks.form.name_hint": "Required: provide a unique network name.",
        "networks.form.driver": "Driver",
        "networks.form.internal": "Internal",
        "networks.form.attachable": "Attachable",
        "networks.form.subnet": "IPv4 subnet",
        "networks.form.gateway": "IPv4 gateway",
        "networks.form.labels": "Labels (optional)",
        "networks.form.add_label": "Add label",
        "networks.form.key": "Key",
        "networks.form.value": "Value",
        "networks.form.cancel": "Cancel",
        "networks.form.create": "Create",
        "networks.protected_hint": "System network protected",
        "networks.details.attached_containers": "Attached containers",
        "networks.details.no_containers": "No containers attached",
        "networks.details.no_ipam": "No IPAM configuration",
        "networks.disconnect": "Disconnect",
        "networks.confirm_delete": "Delete network {name}?",
        "networks.confirm_disconnect": "Disconnect container from network?",
        ...
        "language.italian": "Italiano",
        "language.english": "English",
        "compact_mode.label": "Compact mode",
        "compact_mode.hint": "Tightens spacing for small screens.",
        ...
        "home.toggle_section": "Show or hide section",
        ...
        "common.mqtt_log": "Publish log",
        "updates.title": "Update check",
        "updates.summary": "{containers} containers scanned · {images} images installed",
        "updates.performance_hint.title": "Performance mode enabled",
        "updates.performance_hint.body": "Automatic scanning is disabled to reduce load. Run it manually when needed.",
        "updates.manual_scan": "Scan for updates",
        "updates.table.installed_version": "Installed version",
        "updates.table.remote_version": "Remote version",
        "updates.table.change_log": "Change log",
        "updates.table.breaking": "Breaking",
        "updates.status.update_available": "Update available",
        "updates.status.up_to_date": "Up to date",
        "updates.status.unknown": "Unknown",
        "updates.status.remote_version": "Remote: {version}",
        "updates.status.pending": "Waiting for registry data",
        "updates.changelog.empty": "No notes",
        "updates.breaking.empty": "No info",
        "updates.actions.update_image": "Update image",
        "updates.actions.confirm": "Update the image for {name}?",
        "updates.confirm.title": "Update image?",
        "updates.debug.eyebrow": "Live debug",
        "updates.debug.title": "Update stream",
        "updates.debug.commands": "Commands",
        "updates.debug.logs": "Live log",
        "updates.debug.clear": "Clear",
        "updates.debug.close": "Close",
        "updates.debug.stream_end": "Stream ended",
        "updates.debug.stream_error": "Stream interrupted",
        "updates.debug.unavailable": "Debug unavailable",
        "updates.debug.request": "Update requested for {name}",
        "updates.debug.state": "State: {state}",
        "updates.confirm.prompt": "Do you want to update the image for \"{name}\"?",
        "updates.confirm.default_name": "this container",
    },
}
